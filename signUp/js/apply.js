    ...
    $("#name").blur(function() {     
        ...
        if (!reName.test(name)) {
            ...
            $.ajax({
                url: "http://localhost/CodeIgniter/index.php/Blog/checkName",
                type:"POST",
                dataType:'json',
                data:{
                    "name":name,
    ...
    $("#email").blur(function() {
        ...
        if (!regEmail.test(email)) {
            ...
            $.ajax({
                url: "http://localhost/CodeIgniter/index.php/Blog/checkEmail",
                type:"POST",
                dataType:'json',
                data:{
                    "email":email,
    ...
    $("#apply").click(function(){
       if ($("#regName").is(':visible') && $("#regPassword").is(':visible') && $("#regEmail").is(':visible') && $("#regPhone").is(':visible')) {
        ...
        var phone = $("#phone").val();
        $.ajax({
            url:"http://localhost/CodeIgniter/index.php/Blog/signUp",
            type:"POST",
            dataType:"json",
            data:{
                "name":name,
